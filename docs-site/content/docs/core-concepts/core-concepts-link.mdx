...
See [Communication Transport](/core-concepts/communication-transport) for detailed comparison and [Network Communication](/core-concepts/network-communication) for multi-machine setup.
...
For the full API reference, see [Core API Reference](/api/core#link).
